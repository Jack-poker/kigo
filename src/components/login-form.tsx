      ...
      <Card className="overflow-hidden bg-[hsl(var(--primary))] ">
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8">
              ...
              <div className="flex flex-col items-center text-center">
               {is_LoginComplete ? (
                ...
                <>
                  ...
                  <Input
                    className="bg-white-900 text-white text-center text-lg tracking-widest"
                    id="otp"
                    type="text"
            ...
            <div className="relative  flex flex-col items-center hidden h-full bg-white  md:block">
            <img
              src="/assets/side.png"
              alt="Image"
